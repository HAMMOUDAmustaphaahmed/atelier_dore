      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <Reveal className="lg:col-span-5">
            <span className="text-bakery-orange font-semibold tracking-[0.2em] uppercase text-xs">Aujourd'hui en boutique</span>
            <h2 className="font-serif text-display-sm text-bakery-dark mt-3 mb-5 text-balance">L'ardoise du jour, écrite à la craie chaque matin</h2>
            <p className="text-bakery-brown/80 leading-relaxed text-pretty mb-8">
              Les pains varient selon la fournée et l'humeur du levain. Léa peut vous réserver votre pain avant qu'il ne parte.
            </p>
          ...
          <Reveal delay={0.1} x={30} className="lg:col-span-7">
            ...
            >
              ...
              <div className="flex items-baseline justify-between gap-4 mb-6">
                <h3 className="chalk font-hand text-4xl sm:text-5xl">Fournée du jour</h3>
              ...
              <div className="mt-8 pt-5 border-t border-white/15 flex flex-wrap items-center justify-between gap-3">
                ...
                <p className="chalk font-hand text-lg opacity-70">Tarifs en boutique</p>
              </div>
            </motion.div>
          </Reveal>
        </div>
